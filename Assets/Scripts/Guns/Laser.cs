...
public class Laser : Gun
{
    public override void Shoot()
    {
        ...
        GameObject bullet = PhotonNetwork.Instantiate(Path.Combine("PhotonPrefabs", "LaserStaticBlue"), projectileSpawner.transform.position, projectileSpawner.transform.rotation);
